...
const activity: ActivityItem[] = [
  { name: 'Sarah Johnson', initials: 'SJ', avatarColor: 'bg-z-5', desc: 'Upgraded to Pro', time: '2m ago' },
  { name: 'Mike Chen',     initials: 'MC', avatarColor: 'bg-z-5', desc: 'New signup',       time: '15m ago' },
  { name: 'Emma Wilson',   initials: 'EW', avatarColor: 'bg-z-5', desc: 'Payment received', time: '1h ago' },
  { name: 'Alex Brown',    initials: 'AB', avatarColor: 'bg-z-5', desc: 'Support ticket',   time: '2h ago' },
]

export default function RightPanel() {
  return (
    <aside className="w-[270px] min-w-[270px] bg-z-1 border-l border-z-3 flex flex-col h-screen">
      {/* Scrollable content */}
      ...
      <div className="px-4 py-4">
        <div className="bg-z-7 rounded-lg p-5">
          <h3 className="text-title leading-title tracking-title font-semibold text-z-0 mb-2">Upgrade to Enterprise</h3>
          <p className="text-body leading-body tracking-body text-z-5 mb-4">
            Get advanced analytics and priority support
          </p>
          <button className="block w-full bg-z-0 text-z-7 rounded-sm py-2.5 text-body leading-body tracking-body font-semibold hover:bg-z-2 transition-colors">
            Learn More
          </button>
        </div>
      </div>
